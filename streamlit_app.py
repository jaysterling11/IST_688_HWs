...
homework5_page = st.Page("HW5.py", title="Homework 5 - Enhance Your Chatbot", icon="5️⃣")

pg = st.navigation([homework1_page, homework2_page, homework3_page, homework4_page, homework5_page])
pg.run()
